import { ChefHat, Coffee, Wrench, Clock, MessageSquare, Heart } from 'lucide-react';
...
export default function MaintenanceView() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-amber-50 via-orange-50/30 to-indigo-50/50 flex items-center justify-center p-4 relative overflow-hidden font-sans">
      {/* Decorative blurred background blobs */}
      <div className="absolute -top-24 -left-24 w-96 h-96 bg-orange-200/40 rounded-full blur-3xl animate-pulse duration-3000" />
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-indigo-200/40 rounded-full blur-3xl animate-pulse duration-4000 [animation-delay:1.5s]" />
      ...
      <div className="bg-white/70 backdrop-blur-2xl border border-white/50 shadow-[0_32px_80px_rgba(249,115,22,0.08)] rounded-[2.5rem] p-8 md:p-12 max-w-lg w-full text-center relative z-10 flex flex-col items-center">
        ...
        <p className="text-slate-600 font-medium text-sm md:text-base leading-relaxed mb-6">
          Chers gourmets, afin de vous concocter une expérience de commande encore plus savoureuse et fluide, la plateforme <span className="font-bold text-slate-700">Gastronomie Service</span> est temporairement en cuisine. 
        </p>
